...
public class DirectedGraph {
	...
	*/
	...
	public void increaseFlow(int increase, Edge e){
		if(adjMatrix[e.getSourceVertex().getLabel()][e.getTargetVertex().getLabel()] == null){
			adjMatrix[e.getTargetVertex().getLabel()][e.getSourceVertex().getLabel()].addFlow(-increase);
		}
		else{
			adjMatrix[e.getSourceVertex().getLabel()][e.getTargetVertex().getLabel()].addFlow(increase);
		}
	}
